              ...
              <div className=" flex flex-col justify-between items-center py-2 p-4 w-full h-fit border-violet-400">
                ...
                <form className="w-full FlexCenterCol mx-auto" onSubmit={onSubmit}>
                  ...
                  <div className="PromptGroup mx-auto flex flex-col justify-center p-4">
                    ...
                    <textarea
                      className="whitespace-nowrap px-4 pt-2 border-0 outline-0 textEngine text-sm text-transparent font-mont focus:text-white focus:shadow-pink-500 shadow-2xl shadow-black  "
                      id=""
                      // rows={1}
                      type="text"
                      name="openaiAPIKey"
                  ...
                  <div className="PromptGroup ">
                    ...
                    <textarea
                      className="textEngine py-4 px-4 pb-8 border-0 outline-0 shadow-2xl shadow-black "
                      id=""
                      // rows={2}
                      type="text"
                      name="request"
                  ...
                  <div className=" PromptGroup ">
                    ...
                    <textarea
                      className="textEngine pt-4 pb-6 px-4 border-0 outline-0 shadow-2xl shadow-black"
                      type="text"
                      name="text"
                      // rows={3}
